...
function calculateProbability() {
    ...
    if (premiumCards.includes(card1Rank) && premiumCards.includes(card2Rank)) {
      document.getElementById('result').innerHTML = 'Probability of winning is very high. May consider playing.';
    }
    else if ((premiumCards.includes(card1Rank) && highCards.includes(card2Rank)) ||  (highCards.includes(card1Rank) && premiumCards.includes(card2Rank))){
      ...
      document.getElementById('result').innerHTML = 'Probability of winning is Okay. May consider playing.';
    } 
